...
export const WORKFLOW_STEPS: Record<WorkflowStep, Omit<WorkflowStepData, 'completed' | 'current' | 'locked'>> = {
  ...
  payment3: { id: 'payment3', title: 'Third Installment', description: 'Payment installment 3', icon: '🔒', order: 8 },
  workpermit: { id: 'workpermit', title: 'Work Permit / DREET', description: 'Work Permit / DREET Documents', icon: '🔒', order: 9 },
