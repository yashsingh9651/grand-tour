...
export default function Payment1Page() {
  ...
  const currencySymbol = paymentConfig.currency?.toUpperCase().includes('USD') ? '$' : 'Γé╣'
    ...
    <StudentLayout
      ...
      headerContent={
        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">
          MANAGEMENT ΓÇ║ <span className="text-[#84CC16] font-extrabold">FINANCIAL CENTER</span>
        </div>
      }
    >
      {/* ΓöÇΓöÇ Page Title ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <div className="mb-8">
      ...
      {/* ΓöÇΓöÇ Top Row: QR + Bank Info ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
        ...
        {/* Bank Information Card ΓÇö dark */}
        <Card className="p-6 border-none rounded-[1.75rem] bg-[#0F172A] text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-5">
              ...
              {/* Account Number ΓÇö spans full width */}
      ...
      {/* ΓöÇΓöÇ Payment Installments ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      <div className="mb-8">
        <div className="flex items-center justify-between mb-5">
                  ...
                  {status === 'VERIFIED' && (
                    <div className="relative group rounded-xl overflow-hidden aspect-[16/9] border border-gray-100 cursor-pointer"
                      onClick={() => {
                        ...
                        setViewingReceiptName(payment?.utrNumber ? `Receipt ΓÇô UTR ${payment.utrNumber}` : 'RECEIPT-001.PDF')
                      }}
                    >
                      <img
      ...
      {/* ΓöÇΓöÇ Bottom Row: Recent Activity + Security ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
              ...
              paymentHistory.slice(0, 4).map((payment: any) => (
                <div key={payment.id} className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-extrabold text-gray-900">Γé╣{Number(payment.amount || 0).toLocaleString()}</p>
      ...
      {/* ΓöÇΓöÇ Lightbox Modal ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      {viewingProofUrl && (
      ...
      {/* ΓöÇΓöÇ Submit Payment Modal ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
