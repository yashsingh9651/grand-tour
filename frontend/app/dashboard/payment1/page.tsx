        ...
        <Card className="p-4 sm:p-6 lg:p-8 border border-border bg-card rounded-2xl sm:rounded-[2.5rem] shadow-sm text-foreground">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-base sm:text-xl font-black">1st Installment Fee</h2>

                <p className="text-2xl sm:text-3xl font-black text-primary">{currencySymbol}{installmentAmount.toLocaleString()}</p>
              </div>
            </div>
