  ...
  return (
    <section className="relative w-full bg-[#0A0B0D] py-20 sm:py-32 px-4 sm:px-8 md:px-12 border-b border-zinc-900 overflow-hidden text-white">
      ...
      <div className="w-full relative z-10 space-y-16">
        ...
        {/* Cards Row */}
        <div className="relative flex flex-col md:flex-row gap-8 lg:gap-12 items-stretch justify-center max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="flex-1 bg-[#121316] border border-white/5 rounded-[2.2rem] p-8 sm:p-12 text-left space-y-6 shadow-[0_30px_70px_rgba(0,0,0,0.4)] transition-colors duration-300"
          >
            {/* Red Target Icon */}
